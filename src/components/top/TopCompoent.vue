  ...
  <div class="top">
    ...
    <div class="right">
      ...
      <span v-show="!userStore.userInfo.uuid" style="padding-right: 15px">
        <el-link :underline="false" type="default" @click="showLogin">注册</el-link>
        <el-divider direction="vertical" />
        <el-link :underline="false" type="default" @click="showLogin">登录</el-link>
      </span>
    </div>
  </div>
</template>
