  ...
  <div class="task-manager">
    ...
    <div class="content">
      <el-table
        ...
        row-class-name="row"
      >
        <el-table-column fixed prop="taskName" label="任务名称" width="200" show-overflow-tooltip>
        ...
        <el-table-column prop="sourceType" label="数据来源类型" width="150" show-overflow-tooltip />
        <el-table-column prop="sourceInfo" label="来源信息" width="200" show-overflow-tooltip />
        <el-table-column prop="sinkType" label="数据去向类型" width="150" show-overflow-tooltip />
        ...
        <el-table-column prop="updateTime" label="最近修改时间" width="200" show-overflow-tooltip />
